...
extension DebtQueryFilter on QueryBuilder<Debt, Debt, QFilterCondition> {
  QueryBuilder<Debt, Debt, QAfterFilterCondition> amountEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Debt, Debt, QAfterFilterCondition> nameEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Debt, Debt, QAfterFilterCondition> nameGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Debt, Debt, QAfterFilterCondition> nameLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Debt, Debt, QAfterFilterCondition> nameBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Debt, Debt, QAfterFilterCondition> nameStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Debt, Debt, QAfterFilterCondition> nameEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Debt, Debt, QAfterFilterCondition> nameContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'name',
  ...
  QueryBuilder<Debt, Debt, QAfterFilterCondition> nameMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'name',
  ...
  QueryBuilder<Debt, Debt, QAfterFilterCondition> nameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'name',
        value: '',
  ...
  QueryBuilder<Debt, Debt, QAfterFilterCondition> nameIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'name',
        value: '',
...
extension DebtQuerySortBy on QueryBuilder<Debt, Debt, QSortBy> {
  ...
  QueryBuilder<Debt, Debt, QAfterSortBy> sortByName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.asc);
    });
  }

  QueryBuilder<Debt, Debt, QAfterSortBy> sortByNameDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension DebtQuerySortThenBy on QueryBuilder<Debt, Debt, QSortThenBy> {
  ...
  QueryBuilder<Debt, Debt, QAfterSortBy> thenByName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.asc);
    });
  }

  QueryBuilder<Debt, Debt, QAfterSortBy> thenByNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.desc);
    });
  }
...
extension DebtQueryWhereDistinct on QueryBuilder<Debt, Debt, QDistinct> {
  ...
  QueryBuilder<Debt, Debt, QDistinct> distinctByName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension DebtQueryProperty on QueryBuilder<Debt, Debt, QQueryProperty> {
  ...
  QueryBuilder<Debt, int, QQueryOperations> amountProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Debt, String, QQueryOperations> nameProperty() {
    return QueryBuilder.apply(this, (query) {
